            ...
            <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                ...
                <tr>
                    <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center"
                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #242b3d;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                        <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-primary"
                                    ...
                                    style="max-width: 400px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                        </p>
                    </td>
                </tr>
                </tbody>
                ...
                <tr>
                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                ...
                                <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" align="center"
                                    ...
                                    <img src="{{ asset('images/check-48-primary.png') }}" width="48" height="48" alt=""
                        ...
                        <h2 class="o_heading o_text-dark o_mb-xxs"
                            ...
                            Geef je beschikbaarheid op</h2>
                        <p style="margin-top: 0px;margin-bottom: 0px;">Ben jij beschikbaar voor komende diensten?</p>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                ...
                <tr>
                    <td class="o_bg-white o_sans o_text-xs o_text-light o_px-md o_pt-xs" align="center"
                        ...
                        <p style="margin-top: 0px;margin-bottom: 0px;">Diensten</p>
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            <tbody>
                            <tr>
                                <td class="o_bb-light"
                                ...
                                <div class="o_px-xs o_sans o_text-xs o_text-secondary o_left o_xs-center"
                                    ...
                                    <p class="o_text o_text-dark"
                                       style="font-size: 16px;line-height: 24px;color: #242b3d;margin-top: 0px;margin-bottom: 0px;">
                                        <strong>{{ $shift->name }}</strong></p>
                                    <p class="o_mb-xxs" style="margin-top: 0px;margin-bottom: 4px;">{{ $shift->start->format('d-m-Y') }}</p>
                                    <p class="o_text-primary"
                                       style="color: #126de5;margin-top: 0px;margin-bottom: 0px;"><strong>Start dienst {{ $shift->start->format('H:i') }} uur.</strong>
                                    </p>
                                </div>
                            </div>
                            <!--[if mso]></td>
                            <td width="200" align="right" valign="top" style="padding: 0px 8px;"><![endif]-->
...
{{--                                                   style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 7px 16px;mso-text-raise: 3px;">Track--}}
{{--                                                    This Item</a>--}}
                                            </td>
                                        </tr>
                                        </tbody>
...
{{--                                    <p style="margin-top: 0px;margin-bottom: 0px;">AWB YUG3432HJ3474632</p>--}}
                                </div>
                            </div>
                            <!--[if mso]></td></tr>
                            <tr>
                        ...
                        <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            ...
                            <tr>
                                <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                                    ...
                                    <a class="o_text-white" href="{{ config('app.url') }}"
                                       style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Beschikbaarheid opgeven</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <td class="o_re o_px o_pb-lg" align="center"
                        ...
                        <div class="o_col o_col-4"
                            ...
                            <div class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center"
                                ...
                                <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">©{{ date("Y") }}
                                    LifeguardRooster. Alle Rechten Voorbehouden.</p>
